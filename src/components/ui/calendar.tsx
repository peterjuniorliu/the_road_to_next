...
export function Calendar({className, classNames, showOutsideDays = true, ...props}: CalendarProps)
{
    return (
        <DayPicker
            ...
            classNames={{
                months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-8",
                month: "space-y-4",
                ...
                table: "w-full border_collapse space-y-1",
                head_row: "flex",
                head_cell:
            ...
            components={{
                Chevron: ({className: chevronClassName, orientation}) => {
                    ...
                    if (orientation === "up") {
                        return <ChevronUp className={cn("h-4 w-4", chevronClassName)} />;
                    }
