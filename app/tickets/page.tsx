                    ...
                    return (
                        ...
                        >
                            ...
                            <Link
                                ...
                                className="shrink-0 inline-flex items-center justify-center self-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition"
                            >
                                View
                            </Link>
                        </div>
